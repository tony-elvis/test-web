                ...
                <div className="grid w-full grid-cols-1 lg:grid-cols-2 gap-x-10">
                  ...
                  <div className="col-span-1">
                    <Controller
                      ...
                      render={({ field: { onChange, value } }) => (
                        <>
                          <label className="font-apercuBold text-label-secondary">Published</label>
                          <DatePicker
                            selected={value}
                            onChange={onChange}
                            ...
                            minDate={new Date()}
                            dropdownMode="select"
                            className="block w-full px-3 py-2 mt-2 mb-4 placeholder-gray-500 border border-gray-300 rounded-md text-label-secondary font-apercuRegular focus:outline-none focus:border-errand-primary focus:z-10 sm:text-sm"
                          />
                          {errors?.published?.message && (
                            <p className="normal-case text-text-red ">
                              {errors?.published?.message}
                            </p>
                          )}
                        </>
